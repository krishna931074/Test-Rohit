...
async def upload(bot: Client, m: Message):
    ...
    await editable.edit(f"**ₜₕᵤₘₐᵣₑ ₜₓₜ ₖₐ ₛₐᵣₐ  ₗᵢₙₖ 👨‍💻** **{len(links)}**\n\n**JAHA SE DOWNLOAD KARNA HAI WO NUMBER LIKH ** **1**")
    ...
    await editable.edit("**APNA QUALITY CHOOSE KR LE 📸**\n144,240,360,480,720,1080 apna  quality deakh ")
    ...
    await editable.edit("APNA BATCH KA NAAM LIKH LE")
    ...
    await editable.edit("APNA THUMBAIL KA LINK VEAJ /nEg » https://graph.org/file/ce1723991756e48c35aa1.jpg \n Or THUMBNAIL NAHI HAI TO BOL DE= NAHI HAI")
